...
GROUP_SUPPORT = os.environ.get("GROUP_SUPPORT", "sohbetikatarsis") # Botunuzdan yasaklanan kullanıcıların itiraz işlemleri için başvuracağı grup, kanal veya kullanıcı. Boş bırakırsanız otomatik olarak OWNER_ID kimliğine yönlendirecektir.
  ...
  await event.reply("**Merhaba Benim Ve Sahibim Hakkında Bilgi\n\nPython: 3.8.2\nKütüphanem: Telethon\n\nSahibim: @hi Gruplarınızda Üyeleri Etiketlemek için Yaratılmışım**",
                    buttons=(
                      [
                       ...
                       Button.url('Kanal 📣', 'https://t.me/blackmuzikbotu')
                      ],
                      [
                       Button.url('Sahibim 🖥️', 'https://t.me/memokra')
                      ],
                    ),
                    link_preview=False
                   )
